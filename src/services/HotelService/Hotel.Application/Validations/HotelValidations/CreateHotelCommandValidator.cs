...
public class CreateHotelCommandValidator : AbstractValidator<CreateHotelDto>
{
    public CreateHotelCommandValidator()
    {
        ...
        RuleFor(x => x.HotelType)
            ...
            .WithMessage("Invalid hotel type. Valid types: Business, Resort, Boutique, Budget, Luxury");
    ...
    private bool HaveValidCheckInOutTimes(CreateHotelDto dto)
    {
    ...
    private bool HaveAtLeastOneFacility(CreateHotelDto dto)
    {
